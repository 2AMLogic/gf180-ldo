...
Current DUT netlist sha256: `design/netlist/ldo_core.spice` = `5bfa966c7d33005f28ecfe1725af798fbb130154633c334ff6d4d6b419c1889e`, `design/netlist/error_amp.spice` = `76841b846788afb832a627d942baeda532b89249767136f1467bd6c80eff736a`.
...
| Current limit | PASS | fresh | `sim/current-limit/records/20260923-141325-33035d79.md` |
...
| Thermal | PASS | fresh | `sim/current-limit/records/20260923-141325-33035d79.md` |
| Output noise | N/A | N/A | see note below |
| Area | N/A | N/A | see note below |
| Stability | PASS | fresh | `sim/loop-stability/records/20260923-132038-a992b52.md` |
...
- `quiescent-current`: `sim/quiescent-current/records/20260923-141210-33035d7.md` — **PASS**, fresh (matches current `ldo_core`)
  - Overall: PASS
...
- `current-limit`: `sim/current-limit/records/20260923-141325-33035d79.md` — **PASS**, fresh (matches current `ldo_core`)
...
- `current-limit` — only substantiates the '<=290 mW into a short' clause; the '92 mW continuous worst case' clause has no dedicated testbench of its own: `sim/current-limit/records/20260923-141325-33035d79.md` — **PASS**, fresh (matches current `ldo_core`)
