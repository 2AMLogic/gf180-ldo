...
Current DUT netlist sha256: `design/netlist/ldo_core.spice` = `85d4bd2342f486305b86dd3dab2f5fff389b5c6857c0d70eae85bb325f888f83`, `design/netlist/error_amp.spice` = `ddccc445b53c6d3168b61391b802f9b084f6e9589ee01ede3f1b2b65c77ae826`.
...
| Startup | MIXED | STALE | `sim/startup/records/20260915-235845-80a42fc.md` (+ 1 more, see detail) |
...
- `quiescent-current`: `sim/quiescent-current/records/20260915-234352-077e15b.md` — **FAIL**, fresh (matches current `ldo_core`)
  - Overall: FAIL
...
- `startup`: `sim/startup/records/20260915-235845-80a42fc.md` — **PASS**, fresh (matches current `ldo_core`)
  - Overall: PASS
...
16 ratified rows: 12 testable (7 PASS, 4 FAIL, 1 MIXED, 0 UNKNOWN), 4 N/A.
