...
Current DUT netlist sha256: `design/netlist/ldo_core.spice` = `a6718bc6e4200c6427ea6ae4c13aec0a945a98d93791559cbf2585807581e4b1`, `design/netlist/error_amp.spice` = `ddccc445b53c6d3168b61391b802f9b084f6e9589ee01ede3f1b2b65c77ae826`.
...
| Iq (excluding load current) | FAIL | STALE | `sim/quiescent-current/records/20260906-231405-d3cb117.md` (+ 1 more, see detail) |
...
- `quiescent-current`: `sim/quiescent-current/records/20260906-231405-d3cb117.md` — **FAIL**, fresh (matches current `ldo_core`)
  - Overall: FAIL
...
- `startup`: `sim/startup/records/20260906-004356-3093ea1.md` — **FAIL**, stale
  - Overall: FAIL
- `soft-start`: `sim/soft-start/records/20260906-230703-d3cb117.md` — **UNKNOWN**, fresh (matches current `ldo_core`)
