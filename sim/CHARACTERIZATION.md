...
Current DUT netlist sha256: `design/netlist/ldo_core.spice` = `f94ed82615611ef45d672ba66d83b04577010c5be69fddb8f4d1304020c7c0c3`, `design/netlist/error_amp.spice` = `ddccc445b53c6d3168b61391b802f9b084f6e9589ee01ede3f1b2b65c77ae826`.
...
| Iq (excluding load current) | PASS | STALE | `sim/quiescent-current/records/20260919-080719-de8b468.md` (+ 1 more, see detail) |
...
- `quiescent-current`: `sim/quiescent-current/records/20260919-080719-de8b468.md` — **PASS**, fresh (matches current `ldo_core`)
  - Overall: PASS
...
- `startup`: `sim/startup/records/20260916-112114-8b551ab.md` — **PASS**, stale
  - Overall: PASS
- `soft-start`: `sim/soft-start/records/20260919-073737-de8b468.md` — **MIXED**, fresh (matches current `ldo_core`)
